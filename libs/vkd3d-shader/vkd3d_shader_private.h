...
enum vkd3d_shader_error
{
    ...
    VKD3D_SHADER_ERROR_HLSL_INVALID_THREAD_COUNT        = 5018,
    VKD3D_SHADER_ERROR_HLSL_MISSING_ATTRIBUTE           = 5019,
    VKD3D_SHADER_ERROR_HLSL_RECURSIVE_CALL              = 5020,

    VKD3D_SHADER_WARNING_HLSL_IMPLICIT_TRUNCATION       = 5300,
    VKD3D_SHADER_WARNING_HLSL_UNKNOWN_ATTRIBUTE         = 5301,
